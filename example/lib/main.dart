...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> showOfferwallDetailFromUrl(String unitId, String itemId) async {
    ...
    bool result = false;
    try {
      String url = "https://link.adiscope.com/$mediaId/$unitId/0/$itemId";
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: OutlinedButton(
                              ...
                              child: Text("RewardedVideo - IsLoaded")
                          ),
                        ),
                        SizedBox( height: 10,),
                        Container(
                        ...
                        Container(
                          ...
                          child: OutlinedButton(
                              ...
                              child: Text("Interstitial - IsLoaded")
                          ),
                        ),
                        SizedBox( height: 10,),
                        Container(
                        ...
                        Container(
                          ...
                          child: OutlinedButton(
                              ...
                              child: Text("RewardedVideo Interstitial - PreLoad All")
                          ),
                        ),
                        SizedBox( height: 10,),
                        Row(
                        ...
                        Container(
                          ...
                          child: OutlinedButton(
                              ...
                              child: Text("RewardedVideo Interstitial - PreLoad UnitIDs")
                          ),
                        ),
                        SizedBox( height: 10,),
                        Row(
                        ...
                        Container(
                          ...
                          child: OutlinedButton(
                              ...
                              child: Text("RewardedVideo Interstitial - Show")
                          ),
                        ),
                        SizedBox( height: 10,),
                        Container(
                          ...
                          child: OutlinedButton(
                              ...
                              child: Text("RewardedVideo Interstitial - GetUnitStatus")
                          ),
                        ),
                        SizedBox( height: 30,),
                      ],
